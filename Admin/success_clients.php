...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4 mb-4">Success Clients</h1>
        
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Success Clients DataTable
                </div>
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM `success_clients`";
...
if (isset($_POST['deleteUserBtn'])) {
    ...
    $query_remove = "DELETE FROM `success_clients` WHERE `id` = '$userid'";
...
<script>
    window.location.assign("./success_clients.php");
</script>

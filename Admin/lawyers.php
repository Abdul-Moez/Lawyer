                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> <img src="../lawyer_dashboard/user_img/<?php echo $row[10]; ?>" alt="Team Image" style="width: 5rem;"> </td>
...
if (isset($_POST['deleteUserBtn'])) {
    ...
    $query_remove = "DELETE FROM `lawyer` WHERE `id` = '$userid'";
...
<script>
    window.location.assign("./lawyers.php");
</script>

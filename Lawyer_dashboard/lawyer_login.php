                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4" style="font-family: 'Luckiest Guy', cursive;" >Login as a Lawyer</h3></div>
                                    <div class="toggle_btn mb-1 mt-3">
                                        <a href="../user_login.php" class="user_link"><button class="user_btn">Login as a User</button></a>
                                        <a href="lawyer_login.php" class="lawyer_link"><button class="lawyer_btn">Login as a Lawyer</button></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form action="./include/lawyer_auth.inc.php" method="POST">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="lawyer_registration.php">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
